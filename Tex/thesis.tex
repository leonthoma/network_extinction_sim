...
More redundancy among interactions should, in theory, lead to a higher chance of finding an adequate new partner to compensate lost interactions. However, networks with trait based interactions were not showing an increased robustness as one would assume. This could be explained by the amount of extinction simulations that were terminated prematurely. Comparing the percentages of aborted extinction simulations (table \ref{tab:abort_perc}) with the robustness of the respective interaction simulation scenario (figure \ref{fig:auc_cv_norew}) shows that when the percentage of terminated simulations was high, robustness had a higher variance and was generally lower.
